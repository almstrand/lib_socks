...
/**
 * STOMP 1.2 NACK frame.
 */
class NackFrame extends Frame {

  static const String _COMMAND = "NACK";

  NackFrame() : super(_COMMAND);

  /**
   * Construct new NACK frame from parameters.
   *
   * @param id
   *      ID matching the ACK header of the message not being acknowledged.
   * @param contentLength
   ...
   */
  NackFrame.fromParams(String id, {int contentLength, String receipt, String transactionId}) : super(_COMMAND) {
  ...
  /**
   * Construct new NACK frame from STOMP message [headers] and [body].
   *
   * @param frame
   *      The raw frame message consisting of the NACK command, specified [headers], and [body].
   * @param headers
   *      The set of headers parsed from the [frame] data.
   * @param body
   *      The body parsed from the [frame] data.
   */
  NackFrame._fromMessage(String frame, Map<String, String> headers, String body) : super._fromParsedMessage(_COMMAND, frame, headers, body);
